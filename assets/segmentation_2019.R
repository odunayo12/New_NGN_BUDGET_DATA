data_pbi_2019 <- read_csv("Data/Raw/data_pbi_2019.csv",
...
data_pbi_2019_start <- data_pbi_2019 %>% 
  ...
  table_identifier = case_when(str_detect(Data.Column1, "^[0-9]") & is.na(Data.Column3) & is.na(Data.Column4) & is.na(Data.Column5) & !is.na(projectCode)
